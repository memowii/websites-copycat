...
export const JuntosPymes = () => {
  ...
  return (
    <div className="JuntosPymes container py-4">
      <InnerHeading
      ...
      <p>
        ...
        <strong>medianas empresas</strong>, quienes responsablemente decidieron
        cerrar de forma temporal sus establecimientos, debiendo trasladarse al
        ámbito digital.
      </p>
      ...
      <p>
        ...
        <strong>auditoría de marketing digital sin costo</strong>. Te invitamos
        a seguirnos en <a href="#">Facebook</a> o <a href="#">Instagram</a>,
        donde daremos a conocer los resultados el 27 de junio, Día de las
